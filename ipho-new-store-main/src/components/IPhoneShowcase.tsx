...
const iphones = [
  { name: "iPhone 16 Pro Max", badge: "NOVO", specs: "256GB · Titânio Deserto · Dynamic Island", model: "16PM" },
  ...
  { name: "iPhone 15", badge: "SEMINOVO", specs: "128GB · Rosa · Dynamic Island", model: "15" },
